...
% Created 11-Nov-2015 16:38:31
%
% This script assumes these variables are defined:
%
%   variables - input time series.
%   vol - target time series.

clear;
load('round1TDailyData.mat');
variables=table2array(round1TDailyData(:,[2 : 8 11 12]));
vol=table2array(round1TDailyData(:,9));
time=datetime(table2array(round1TDailyData(:,1)));


X = tonndata(variables,false,false);
...
MAPE = mean(abs(transpose([cell2mat(e) 0])./vol))*100;

figure
plot(time,[cell2mat(y) 0],time,vol);
